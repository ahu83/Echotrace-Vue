...
export class FlvDemuxer {
     ...
     * @returns {DemuxResult}
     */
    demux(data: Uint8Array, discontinuity?: boolean, contiguous?: boolean, seamlessLoadingSwitching: any): DemuxResult;
    seamlessLoadingSwitching: boolean;
    /**
     ...
     * @returns {DemuxResult}
     */
    demuxAndFix(data: Uint8Array, discontinuity?: boolean, contiguous?: boolean, startTime?: number, seamlessLoadingSwitching: any): DemuxResult;
    /**
     * @param {Uint8Array} data
     * @param {number} pts
     * @private
     ...
     */
    _parseG711(data: Uint8Array, pts: number, format: any): void;
