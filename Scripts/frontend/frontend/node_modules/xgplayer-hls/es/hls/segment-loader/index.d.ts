...
export class SegmentLoader {
    ...
    _mapCache: {};
    _keyCache: {};
    _segmentLoader: NetLoader;
    _audioSegmentLoader: NetLoader;
    _keyLoader: NetLoader;
    speedInfo(): {
        speed: number;
        avgSpeed: number;
    };
     ...
     */
    load(seg: MediaSegment, audioSeg: MediaSegment, loadInit: boolean, loadAudioInit?: boolean): Promise<{
        data: any;
        map: any;
        key: any;
        mapKey: any;
     ...
     * @param {boolean} loadInit
     */
    loadVideoSegment(seg: MediaSegment, loadInit: boolean): Promise<{
        data: any;
        map: any;
        key: any;
        mapKey: any;
     ...
     * @param {boolean} loadInit
     */
    loadAudioSegment(seg: MediaSegment, loadInit: boolean): Promise<{
        data: any;
        map: any;
        key: any;
        mapKey: any;
     ...
     * @param {boolean} loadInit
     */
    _loadSegment(segLoader: NetLoader, seg: MediaSegment, loadInit: boolean): Promise<{
        data: any;
        map: any;
        key: any;
        mapKey: any;
