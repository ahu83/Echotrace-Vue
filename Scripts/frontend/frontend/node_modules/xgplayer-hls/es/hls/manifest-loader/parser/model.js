...
var HlsUrlParameters = /* @__PURE__ */ function() {
  function HlsUrlParameters2(msn, part, skip) {
    _classCallCheck(this, HlsUrlParameters2);
    this.msn = msn;
    this.part = part;
    this.skip = skip;
  }
  _createClass(HlsUrlParameters2, [{
    key: "addDirectives",
...
export { AudioStream, HlsUrlParameters, MasterPlaylist, MasterStream, MediaPlaylist, MediaSegment, MediaSegmentKey, MediaStream, SubTitleStream };
