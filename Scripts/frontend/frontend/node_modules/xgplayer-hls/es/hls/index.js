...
import { Logger, StreamingError, isMediaPlaying, SeiService, GapService, MediaStatsService, MSE, Buffer, getVideoPlaybackQuality, ERR } from "xgplayer-streaming-shared";
...
_defineProperty(Hls, "version", "3.0.21");
try {
