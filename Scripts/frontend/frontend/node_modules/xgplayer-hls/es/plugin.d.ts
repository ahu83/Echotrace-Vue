 ...
 * @returns
 */
export function parseSwitchUrlArgs(args: import('xgplayer').SwitchUrlOptions, plugin: HlsPlugin): {
    startTime: number;
    seamless?: boolean;
};
export class HlsPlugin extends BasePlugin {
    ...
    static EVENT: {
        STREAM_PARSED: string;
        NO_AUDIO_TRACK: string;
        SUBTITLE_SEGMENTS: string;
        SUBTITLE_PLAYLIST: string;
        SEI_PAYLOAD_TIME: string;
        APPEND_COST: string;
        ERROR: string;
        TTFB: string;
        LOAD_START: string;
    ...
    logger: import("xgplayer-streaming-shared").Logger;
    /**
     * @type {Hls}
     */
    hls: Hls;
     ...
     */
    getStats: () => import('./hls').Stats | undefined;
